...
public class DataHelper {
    ...
    public static Card getValidDeclineCard() {
    ...
    public static Card getValidCardAndRandomInvalidFields() {
        return new Card(getApprovedNumber(), getThirteenMonth(), getYear(10),
                getRuHolder(), getZeroSymbolCVC());
    }

    public static Card getValidApprovedNumberAndEmptyFields() {
        return new Card(getApprovedNumber(), getEmptyMonth(), getEmptyYear(),
                getEmptyHolder(), getEmptyCVC());
    }

    public static Card getRandomCardAndValidFields() {
